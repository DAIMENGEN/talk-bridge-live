...
export const AudioIcon: React.FC<{ width: number, height: number, color: string }> = (props) => {
    const audioIcon = () => (
        <svg className="audio-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    return <Icon component={audioIcon} {...props}/>
}