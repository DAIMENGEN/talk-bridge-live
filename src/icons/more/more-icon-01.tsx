...
export const MoreIcon01: React.FC<{ width: number, height: number, color: string }> = (props) => {
    const moreIcon = () => (
        <svg className="more-icon-01" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
